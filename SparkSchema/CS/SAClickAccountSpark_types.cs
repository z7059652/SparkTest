...
//     File     : SAClickAccountSpark_types.cs
//
...
public partial class SAClickAccountSpark : IBondSerializable, IGenericSerializer
{
    //
    // Fields
    //

    // 1: Optional nullable<int32> customerId
    ...
    private static class Schema
    {
        ...
        static Schema()
        {
            ...
            runtimeName.Append("SAClickAccountSpark");
    ...
    {
        global::SparkSchema.SAClickAccountSpark cloned = new global::SparkSchema.SAClickAccountSpark();
        CopyTo(cloned);
        return cloned;
    }
    ...
    /// CopyTo
    /// </summary>
    public void CopyTo(global::SparkSchema.SAClickAccountSpark that)
    {
        if (that == null)
        {
    ...
    protected  void Read(global::Microsoft.Bond.IProtocolReader reader, out bool isPartialStruct)
    {
        ...
        while (true)
        {
            ...
            switch (id)
            {
                case __ordinals.customerId:  // id=1
    ...
    {
        if (type == typeof(SAClickAccountSpark))
        {
            Write(writer, true);
        }
    }
    ...
    protected void WriteInternal(global::Microsoft.Bond.IProtocolWriter writer, bool isTopLevel)
    {
        ...
        UInt32 count1 = (UInt32)((m_customerId != null) ? 1 : 0);
        if (writeAllFields || count1 != 0)
        {
            writer.WriteFieldBegin(global::Microsoft.Bond.BondDataType.BT_LIST, __ordinals.customerId, Schema.customerId_meta);
                writer.WriteContainerBegin(count1, global::Microsoft.Bond.BondDataType.BT_INT32);
                if (count1 != 0)
                {
        ...
        UInt32 count2 = (UInt32)((m_AdId != null) ? 1 : 0);
        ...
        UInt32 count3 = (UInt32)((m_MUID != null) ? 1 : 0);
        ...
        UInt32 count4 = (UInt32)((m_ANID != null) ? 1 : 0);
        ...
        UInt32 count5 = (UInt32)((m_AnalyticsGUID != null) ? 1 : 0);
    ...
    public virtual bool MemberwiseCompare(object obj)
    {
        ...
        SAClickAccountSpark that = obj as SAClickAccountSpark;
        if (that == null)
        {
            return false;
        }
    ...
    /// MemberwiseCompare
    /// </summary>
    public bool MemberwiseCompare(SAClickAccountSpark other)
    {
    ...
    /// </summary>
    protected bool MemberwiseCompareQuick(SAClickAccountSpark that)
    {
        bool equals = true;
    ...
    /// </summary>
    protected bool MemberwiseCompareDeep(SAClickAccountSpark that)
    {
        bool equals = true;
