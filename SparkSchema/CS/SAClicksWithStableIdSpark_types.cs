...
//     File     : SAClicksWithStableIdSpark_types.cs
//
...
/// <summary>
/// SAClicksWithStableIdSpark
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("bondc.exe", null)]
public partial class SAClicksWithStableIdSpark : IBondSerializable, IGenericSerializer
{
    //
    // Fields
    //
    ...
    // 2: Optional string ClickId
    private String m_ClickId;

    // 3: Optional int64 Timestamp
    private Int64 m_Timestamp;

    // 4: Optional nullable<uint64> AdId
    private UInt64? m_AdId;

    // 5: Optional int32 AdvertiserAccountId
    private Int32 m_AdvertiserAccountId;

    // 6: Optional nullable<int32> customerId
    private Int32? m_customerId;

    // 7: Optional Microsoft.Bond.GUID StableId
    private global::Microsoft.Bond.GUID m_StableId;

    // 8: Optional SparkSchema.UETUserIdTypeSpark UserIdType
    private global::SparkSchema.UETUserIdTypeSpark m_UserIdType;

    // 9: Optional SparkSchema.PSCFRSpark pscfrdata
    ...
    /// StableId
    /// </summary>
    public global::Microsoft.Bond.GUID StableId
    {
        get { return this.m_StableId; }
        set { this.m_StableId = value; }
    }

    /// <summary>
    /// UserIdType
    /// </summary>
    public global::SparkSchema.UETUserIdTypeSpark UserIdType
    {
        get { return this.m_UserIdType; }
        set { this.m_UserIdType = value; }
    }
    ...
    private static class Schema
    {
        ...
        public static readonly Metadata StableId_meta = new Metadata();
        public static readonly Metadata UserIdType_meta = new Metadata();
        public static readonly Metadata pscfrdata_meta = new Metadata();

        static Schema()
        {
            StringBuilder runtimeName = new StringBuilder();
            runtimeName.Append("SAClicksWithStableIdSpark");
            ...
            // StableId
            StableId_meta.name = "StableId";
            StableId_meta.modifier = global::Microsoft.Bond.Modifier.Optional;

            // UserIdType
            UserIdType_meta.name = "UserIdType";
            UserIdType_meta.modifier = global::Microsoft.Bond.Modifier.Optional;

            UserIdType_meta.default_value.int_value = Convert.ToInt64(global::SparkSchema.UETUserIdTypeSpark.UAIPID);
    ...
    private static class __ordinals
    {
        ...
        public const int ClickId = 2;
        public const int Timestamp = 3;
        public const int AdId = 4;
        public const int AdvertiserAccountId = 5;
        public const int customerId = 6;
        public const int StableId = 7;
        public const int UserIdType = 8;
        public const int pscfrdata = 9;
    }   // ~__ordinals
    ...
    private static class __internal
    {
        ...
        public const String s_StableId = "StableId";
        public const String s_UserIdType = "UserIdType";
    ...
    /// Constructor
    /// </summary>
    public SAClicksWithStableIdSpark()
    {
        Reset();
    }
    ...
    private void ResetImpl(string name, string qualifiedName)
    {
        ...
        m_StableId = new global::Microsoft.Bond.GUID();
        m_UserIdType = global::SparkSchema.UETUserIdTypeSpark.UAIPID;
    ...
    {
        global::SparkSchema.SAClicksWithStableIdSpark cloned = new global::SparkSchema.SAClicksWithStableIdSpark();
        CopyTo(cloned);
        return cloned;
    }
    ...
    /// CopyTo
    /// </summary>
    public void CopyTo(global::SparkSchema.SAClicksWithStableIdSpark that)
    {
        if (that == null)
        {
        ...
        that.AdId = this.AdId;
        // 5: int32 AdvertiserAccountId
        that.AdvertiserAccountId = this.AdvertiserAccountId;
        // 6: nullable<int32> customerId
        that.customerId = this.customerId;
        // 7: Microsoft.Bond.GUID StableId
        that.StableId = (this.StableId == null ? null : (global::Microsoft.Bond.GUID)this.StableId.Clone());
        // 8: SparkSchema.UETUserIdTypeSpark UserIdType
        that.UserIdType = this.UserIdType;
        // 9: SparkSchema.PSCFRSpark pscfrdata
    ...
    protected  void ReadUntagged(global::Microsoft.Bond.IProtocolReader reader)
    {
        ...
        if (!canOmitFields || !reader.ReadFieldOmitted())
        {
            this.StableId.Read(reader);
        }

        if (!canOmitFields || !reader.ReadFieldOmitted())
        {
            this.UserIdType = (global::SparkSchema.UETUserIdTypeSpark)reader.ReadInt32();
        }
        ...
        while (true)
        {
            ...
            switch (id)
            {
                ...
                case __ordinals.Timestamp:  // id=3
                    ...
                    break;
                case __ordinals.AdId:  // id=4
                    this.ReadField_impl_AdId(reader, type);
                    break;
                case __ordinals.AdvertiserAccountId:  // id=5
                ...
                case __ordinals.customerId:  // id=6
                    ...
                    break;
                case __ordinals.StableId:  // id=7
                    global::Microsoft.Bond.ReadHelper.ValidateType(type, global::Microsoft.Bond.BondDataType.BT_STRUCT);
                    this.StableId.Read(reader);
                    break;
                case __ordinals.UserIdType:  // id=8
                    this.UserIdType = (global::SparkSchema.UETUserIdTypeSpark)global::Microsoft.Bond.ReadHelper.ReadInt32(reader, type);
                    break;
                case __ordinals.pscfrdata:  // id=9
                    global::Microsoft.Bond.ReadHelper.ValidateType(type, global::Microsoft.Bond.BondDataType.BT_STRUCT);
                    this.pscfrdata.Read(reader);
                    break;
                default:
    ...
    {
        if (type == typeof(SAClicksWithStableIdSpark))
        {
            Write(writer, true);
        }
    }
    ...
    protected void WriteInternal(global::Microsoft.Bond.IProtocolWriter writer, bool isTopLevel)
    {
        ...
        UInt32 count2 = (UInt32)((m_customerId != null) ? 1 : 0);
        ...
        writer.WriteFieldBegin(global::Microsoft.Bond.BondDataType.BT_STRUCT, __ordinals.StableId, Schema.StableId_meta);
            m_StableId.Write(writer, true);
        writer.WriteFieldEnd();
        if (writeAllFields || (!Schema.UserIdType_meta.default_value.Equals(Convert.ToInt32(m_UserIdType))))
        {
            writer.WriteFieldBegin(global::Microsoft.Bond.BondDataType.BT_INT32, __ordinals.UserIdType, Schema.UserIdType_meta);
                writer.WriteInt32((Int32)m_UserIdType);
            writer.WriteFieldEnd();
        }
        else
        {
            writer.WriteFieldOmitted(global::Microsoft.Bond.BondDataType.BT_INT32, __ordinals.UserIdType, Schema.UserIdType_meta);
        }
    ...
    static protected UInt16 GetStructDef(global::Microsoft.Bond.SchemaDef schema)
    {
        ...
        field = new global::Microsoft.Bond.FieldDef();
        field.id = 8;
        field.metadata.name="UserIdType";
        field.metadata.modifier = global::Microsoft.Bond.Modifier.Optional;
        field.metadata.default_value.nothing = false;
    ...
    public virtual bool MemberwiseCompare(object obj)
    {
        ...
        SAClicksWithStableIdSpark that = obj as SAClicksWithStableIdSpark;
        if (that == null)
        {
            return false;
        }
    ...
    /// MemberwiseCompare
    /// </summary>
    public bool MemberwiseCompare(SAClicksWithStableIdSpark other)
    {
    ...
    /// </summary>
    protected bool MemberwiseCompareQuick(SAClicksWithStableIdSpark that)
    {
        bool equals = true;
        ...
        equals = equals && ((this.UserIdType == that.UserIdType));
        return equals;
    }    // ~MemberwiseCompareQuick
    ...
    /// </summary>
    protected bool MemberwiseCompareDeep(SAClicksWithStableIdSpark that)
    {
        bool equals = true;
        ...
        equals = equals && (this.StableId == null ? true : this.StableId.MemberwiseCompare(that.StableId));
    ...
    public  string ToString(bool valuesOnly, char separator)
    {
        ...
        sb.AppendFormat(format, __internal.s_StableId, this.StableId, separator);
        sb.AppendFormat(format, __internal.s_UserIdType, this.UserIdType, separator);
        sb.AppendFormat(format, __internal.s_pscfrdata, this.pscfrdata, separator);
        
        return sb.ToString();
    } // ToString()

}; // class SAClicksWithStableIdSpark
} // namespace SparkSchema
