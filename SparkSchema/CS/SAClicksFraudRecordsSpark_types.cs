...
//     File     : SAClicksFraudRecordsSpark_types.cs
//
...
/// <summary>
/// SAClicksFraudRecordsSpark
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("bondc.exe", null)]
public partial class SAClicksFraudRecordsSpark : IBondSerializable, IGenericSerializer
{
    //
    // Fields
    //
    ...
    // 6: Optional nullable<Microsoft.Bond.GUID> MUID
    private global::Microsoft.Bond.GUID m_MUID;

    // 7: Optional nullable<Microsoft.Bond.GUID> ANID
    private global::Microsoft.Bond.GUID m_ANID;

    // 8: Optional nullable<Microsoft.Bond.GUID> AnalyticsGUID
    ...
    private static class Schema
    {
        ...
        static Schema()
        {
            ...
            runtimeName.Append("SAClicksFraudRecordsSpark");
    ...
    private static class __ordinals
    {
        ...
        public const int MUID = 6;
        public const int ANID = 7;
        public const int AnalyticsGUID = 8;
    ...
    /// Constructor
    /// </summary>
    public SAClicksFraudRecordsSpark()
    {
        Reset();
    }
    ...
    {
        global::SparkSchema.SAClicksFraudRecordsSpark cloned = new global::SparkSchema.SAClicksFraudRecordsSpark();
        CopyTo(cloned);
        return cloned;
    }
    ...
    /// CopyTo
    /// </summary>
    public void CopyTo(global::SparkSchema.SAClicksFraudRecordsSpark that)
    {
        if (that == null)
        {
        ...
        while (true)
        {
            ...
            switch (id)
            {
                ...
                case __ordinals.AdvertiserAccountId:  // id=5
                    ...
                    break;
                case __ordinals.MUID:  // id=6
                    this.ReadField_impl_MUID(reader, type);
                    break;
                case __ordinals.ANID:  // id=7
                    this.ReadField_impl_ANID(reader, type);
                    break;
                case __ordinals.AnalyticsGUID:  // id=8
    ...
    {
        if (type == typeof(SAClicksFraudRecordsSpark))
        {
            Write(writer, true);
        }
    }
    ...
    public virtual bool MemberwiseCompare(object obj)
    {
        ...
        SAClicksFraudRecordsSpark that = obj as SAClicksFraudRecordsSpark;
        if (that == null)
        {
            return false;
        }
    ...
    /// MemberwiseCompare
    /// </summary>
    public bool MemberwiseCompare(SAClicksFraudRecordsSpark other)
    {
    ...
    /// </summary>
    protected bool MemberwiseCompareQuick(SAClicksFraudRecordsSpark that)
    {
        bool equals = true;
    ...
    /// </summary>
    protected bool MemberwiseCompareDeep(SAClicksFraudRecordsSpark that)
    {
        bool equals = true;
...
}; // class SAClicksFraudRecordsSpark
} // namespace SparkSchema
